...
namespace ini_read_write
{
    class IniManager
    {
        ...
        lpDefault, StringBuilder lpReturnedString, int nSize, string lpFileName);
        ...
        public string ReadIniFile(string section, string key, string defaultValue)
        {
            ...
            GetPrivateProfileString(section, key, defaultValue, lpReturnedString, bufferSize,
            filePath);
